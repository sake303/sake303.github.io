...
- Signal Guide funnel (2026-08-21): added one bordered conversion hinge inside the field note. The purchase action stays typographic and compact; no card grid or SaaS-style chrome was introduced.
...
- **Structure:** a bordered pause in the reading flow with the early-access price, one purchase action, privacy note, and an in-page link to delivery and refund terms.
